...
export const DataApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addData(data?: Data, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Data>> {
            const localVarFetchArgs = DataApiFetchParamCreator(configuration).addData(data, options);
         ...
         * @throws {RequiredError}
         */
        getDataById(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Data> {
            const localVarFetchArgs = DataApiFetchParamCreator(configuration).getDataById(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        updateData(data?: Data, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Data>> {
            const localVarFetchArgs = DataApiFetchParamCreator(configuration).updateData(data, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const OptionApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        addOption(option?: Option, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"Option" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(option || {}) : (option || "");
        ...
        getOptionId(id: string, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling getOptionId.');
            }
            const localVarPath = `/option`;
            const localVarUrlObj = url.parse(localVarPath, true);
            let baseOptions;
...
export const OptionApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addOption(option?: Option, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Option>> {
            const localVarFetchArgs = OptionApiFetchParamCreator(configuration).addOption(option, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getOptionId(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Option> {
            const localVarFetchArgs = OptionApiFetchParamCreator(configuration).getOptionId(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        updateOption(option?: Option, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Option>> {
            const localVarFetchArgs = OptionApiFetchParamCreator(configuration).updateOption(option, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const OptionApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary addOption
        ...
        getOptionId(id: string, options?: any) {
            return OptionApiFp(configuration).getOptionId(id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary updateOption
...
export class OptionApi extends BaseAPI {
    ...
    public addOption(option?: Option, options?: any) {
        return OptionApiFp(this.configuration).addOption(option, options)(this.fetch, this.basePath);
    }
    ...
    public getOptionId(id: string, options?: any) {
        return OptionApiFp(this.configuration).getOptionId(id, options)(this.fetch, this.basePath);
    }
    ...
    public updateOption(option?: Option, options?: any) {
        return OptionApiFp(this.configuration).updateOption(option, options)(this.fetch, this.basePath);
    }
...
export const TemplateApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        addTemplate(template?: Template, options: any = {}): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(template || {}) : (template || "");
        ...
        getTemplateId(id: string, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling getTemplateId.');
            }
            const localVarPath = `/template`;
            const localVarUrlObj = url.parse(localVarPath, true);
            let baseOptions;
...
export const TemplateApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addTemplate(template?: Template, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Template>> {
            const localVarFetchArgs = TemplateApiFetchParamCreator(configuration).addTemplate(template, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getTemplateId(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Template> {
            const localVarFetchArgs = TemplateApiFetchParamCreator(configuration).getTemplateId(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        updateTemplate(template?: Template, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Template>> {
            const localVarFetchArgs = TemplateApiFetchParamCreator(configuration).updateTemplate(template, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export class TemplateApi extends BaseAPI {
    ...
    public addTemplate(template?: Template, options?: any) {
        return TemplateApiFp(this.configuration).addTemplate(template, options)(this.fetch, this.basePath);
    }
    ...
    public getTemplateId(id: string, options?: any) {
        return TemplateApiFp(this.configuration).getTemplateId(id, options)(this.fetch, this.basePath);
    }
    ...
    public updateTemplate(template?: Template, options?: any) {
        return TemplateApiFp(this.configuration).updateTemplate(template, options)(this.fetch, this.basePath);
    }
...
export const WidgetApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addWidget(entire?: Entire, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"Entire" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(entire || {}) : (entire || "");
        ...
        getWidgetById(id: string, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling getWidgetById.');
            }
            const localVarPath = `/widget`;
            const localVarUrlObj = url.parse(localVarPath, true);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        updateWidget(entire?: Entire, options: any = {}): FetchArgs {
            const localVarPath = `/widget`;
            const localVarUrlObj = url.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
...
export const WidgetApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addWidget(entire?: Entire, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Entire> {
            const localVarFetchArgs = WidgetApiFetchParamCreator(configuration).addWidget(entire, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getWidgetById(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Entire> {
            const localVarFetchArgs = WidgetApiFetchParamCreator(configuration).getWidgetById(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getWidgets(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Entire>> {
         ...
         * @throws {RequiredError}
         */
        updateWidget(entire?: Entire, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Entire>> {
            const localVarFetchArgs = WidgetApiFetchParamCreator(configuration).updateWidget(entire, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const WidgetApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary addWidget
         ...
         * @throws {RequiredError}
         */
        addWidget(entire?: Entire, options?: any) {
            return WidgetApiFp(configuration).addWidget(entire, options)(fetch, basePath);
        },
        /**
         * 
         * @summary getWidgetById
         ...
         * @throws {RequiredError}
         */
        updateWidget(entire?: Entire, options?: any) {
            return WidgetApiFp(configuration).updateWidget(entire, options)(fetch, basePath);
        },
    };
};
...
export class WidgetApi extends BaseAPI {
     ...
     * @memberof WidgetApi
     */
    public addWidget(entire?: Entire, options?: any) {
        return WidgetApiFp(this.configuration).addWidget(entire, options)(this.fetch, this.basePath);
    }
    ...
    public getWidgetById(id: string, options?: any) {
        return WidgetApiFp(this.configuration).getWidgetById(id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WidgetApi
     */
    public updateWidget(entire?: Entire, options?: any) {
        return WidgetApiFp(this.configuration).updateWidget(entire, options)(this.fetch, this.basePath);
    }
